...
class rockBlock(object):
        ...
        try:
            ...
            if(self._configurePort()):
                ...
                if(self.ping()):
                    ...
                    if(self.callback is not None and callable(self.callback.rockBlockConnected)):
    ...
    # Handy function to check the connection is still alive, else throw an
    # Exception
    ...
    def messageCheck(self):
        ...
        if(self.callback is not None and callable(self.callback.rockBlockRxStarted)):
        ...
        if(self._attemptConnection() and self._attemptSession()):
            ...
            if(self.callback is not None and callable(self.callback.rockBlockRxFailed)):
    ...
    def sendMessage(self, msg):
        ...
        if(self.callback is not None and callable(self.callback.rockBlockTxStarted)):
        ...
        if(self.callback is not None and callable(self.callback.rockBlockTxFailed)):
            ...
            if(self.s.readline().strip() == command):
                ...
                if(b'+SBDIX' in response):
                    ...
                    if(moStatus <= 4):
                        ...
                        if(self.callback is not None and callable(self.callback.rockBlockTxSuccess)):
                    ...
                    if(self.callback is not None and callable(self.callback.rockBlockRxMessageQueue)):
    ...
    def _attemptConnection(self):
        ...
        while True:
            ...
            if(TIME_ATTEMPTS == 0):
                ...
                if(self.callback is not None and callable(self.callback.rockBlockSignalFail)):
        ...
        while True:
            ...
            if(signal >= SIGNAL_THRESHOLD):
                ...
                if(self.callback is not None and callable(self.callback.rockBlockSignalPass)):
    ...
    def _processMtMessage(self, mtMsn):
        ...
        if(response == "OK"):
            ...
            if(self.callback is not None and callable(self.callback.rockBlockRxReceived)):
    ...
    def _ensureConnectionStatus(self):
        ...
        if(self.s is None or self.s.isOpen() == False):
